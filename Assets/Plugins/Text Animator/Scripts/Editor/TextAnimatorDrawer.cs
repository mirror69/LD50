        ...
        internal class BehaviorDefaultEffects : BuiltinVariablesDrawer
        {
            ...
            public BehaviorDefaultEffects(SerializedProperty defaultValues) : base("Built-in behaviors", docs_builtinEffects + "#behavior-effects")
            {
                behFear = new Effect(
                    ...
                    defaultValues,
                    false,
                    new EffectValuePair { valueName = "fearCurve", label = "Curve" },
                    new EffectValuePair { valueName = "fearStrength", label = "Strength" },
                    new EffectValuePair { valueName = "fearPeakDuration", label = "PeakDuration" },
                    new EffectValuePair { valueName = "fearTransitionDuration", label = "TransitionDuration" },
                    new EffectValuePair { valueName = "fearJoltDuration", label = "JoltDuration" },
                    new EffectValuePair { valueName = "fearDelay", label = "Delay" }
                    );
                ...
                behIrrit = new Effect(
                    ...
                    defaultValues,
                    false,
                    new EffectValuePair { valueName = "irritCurve", label = "Curve" }
                    );
