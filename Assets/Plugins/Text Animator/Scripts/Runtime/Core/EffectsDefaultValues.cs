...
namespace Febucci.UI.Core
{
    ...
    public class BehaviorDefaultValues
    {
        ...
        public class Defaults
        {
            ...
            //fear
            public AnimationCurve fearCurve = AnimationCurve.Linear(0, 0, 1, 1);
            [NotZero] public float fearStrength = 1;
            [NotZero] public float fearPeakDuration = 1;
            [NotZero] public float fearTransitionDuration = 1;
            [NotZero] public float fearJoltDuration = .1f;
            [NotZero] public float fearDelay = 1;

            //irrit
            public AnimationCurve irritCurve = AnimationCurve.Linear(0, 0, 1, 1);
            [NotZero] public float irritStrength = 1;
            [NotZero] public float irritPeakDuration = 1;
            [NotZero] public float irritTransitionDuration = 1;
            [NotZero] public float irritJoltDuration = .04f;
            [NotZero] public float irritDelay = 1;
